...
class Streaming5Page extends StatefulWidget {
  final bool isPub;
  const Streaming5Page(this.isPub, {Key? key}) : super(key: key);

  @override
  State<Streaming5Page> createState() => _Streaming5PageState();
}

class _Streaming5PageState extends State<Streaming5Page>
  ...
  bool useOpenGL = true;
  String streamURL = "rtmp://192.168.29.122:1935/live";
